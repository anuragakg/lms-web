...
<link href="assets/css/plugins/validation/validationEngine.jquery.css" rel="stylesheet">
...
<script type="text/javascript">
	/*window.onload = function () {
		...
		footer_script_href="assets/js/custom/footer.js";
		myScript.setAttribute("src", footer_script_href);
