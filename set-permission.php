            ...
            <div class="container-fluid">
                ...
                <section id="main-content">
                    ...
                    <div class="col-md-12 mt-3">
                            <h6 class="w-100">Set Role Permission</h6>
                                ...
                                <table width="100%" id="list" class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            <th>SR.No</th>
                                            <th>Moddule</th>
                                            <th>Check All <input type="checkbox" onclick="check_uncheck_checkbox(this.checked)"> Permission</th>
                                        </tr>
                                    </thead>
						...
						<button type="submit" class="btn btn-sm btn-primary mt-3" >Save
                    </button>
						</form>
            </div>
...
<script type="text/javascript" src="assets/js/custom/permission-mapping.js?v=<?php echo time();?>"></script> 
